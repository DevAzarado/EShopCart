...
namespace EShopCart.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Authorize]
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (slug != null)
                {
                    ModelState.AddModelError("Name", "The product already exists.");
                    return View(product);
                }
                ...
                TempData["Success"] = $"The product has been edited! Id: {product.Id}";
            }
